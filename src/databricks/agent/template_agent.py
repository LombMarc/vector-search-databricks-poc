...
SYSTEM_PROMPT = """answer always based on information found in the index and use that as your only source of truth. Answer with  'I do not have the required information' if the context is empty"""
